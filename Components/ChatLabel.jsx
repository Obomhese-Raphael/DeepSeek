...
const ChatLabel = ({ openMenu, setOpenMenu }) => {
  return (
    <div className="flex items-center justify-between p-2 text-white/80 hover:bg-white/10 rounded-lg text-sm group cursor-pointer">
      ...
      <div className="group relative flex items-center justify-center w-6 h-6 aspect-square hover:bg-black/80 rounded-lg">
        <Image
        ...
        >
          ...
          <div className="flex items-center gap-3 hover:bg-white/10 px-3 py-2">
            <Image src={assets.delete_icon} alt="pencil icon" className="w-4" />
            <p>Delete</p>
          </div>
        </div>
      </div>
